...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                    <li><a href="index.php"><span class=" icon-home"> 首页 </span> </a></li>
                    ...
                    <li class="active"><a href="index.php?r=site/about"><span class="icon-github"> 关于我们</span></a></li>
        ...
        <script src="./assets/about/vendor/bootstrap/js/bootstrap.min.js"></script>

        <!-- Contact Form JavaScript -->
        <script src="./assets/about/js/jqBootstrapValidation.js"></script>

        <!-- Theme JavaScript -->
        <script src="./assets/about/js/clean-blog.min.js"></script>        
